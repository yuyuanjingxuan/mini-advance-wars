...
| 🪖 **6+2 unit types** | 🪖 Infantry · 🛡️ Heavy · 🚙 Recon · Cannon (range 2-3) · 🔧 Engineer (1.5× capture + vehicle repair) · ⚕️ Medic (heals infantry) · Tank (assault main force) · 🚀 Rocket (range 3-5) |
...
| ⚔️ **Type matchups** | Full damage multiplier table (heavy beats infantry, tank beats infantry, recon beats infantry but loses to heavy, etc.) |
...
> 💡 Forest/mountains grant defense bonuses but slow movement — each unit type has different move costs per terrain (infantry excel in mountains, treads cannot enter mountains); owned buildings heal 2 HP per turn; cannon/rocket cannot fire after moving — they must wait in place to fire.
