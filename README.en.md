...
| 🥾 **Per-unit movement** | Advance Wars style: infantry/heavy/engineer/medic all move identically (forest 1/mountain 2), treads (tank/cannon) forest 2 & no mountains, tires (recon/rocket) forest 3 & no mountains, no plain penalty |
...
| 🔧 **Support units** | Engineer can repair an adjacent vehicle +3 HP, medic can heal an adjacent infantry/heavy/engineer +4 HP (eligible targets are highlighted green when selected — click directly, or click the action button first then pick a target; choose freely when several are adjacent); both have very low ATK (engineer 2 / medic 1) |
