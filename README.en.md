...
| 🔧 **Support units** | Engineer can repair an adjacent vehicle +3 HP, medic can heal an adjacent infantry/engineer +4 HP (triggered from the action button group after selecting the unit, from a move or in place); both have very low ATK (engineer 2 / medic 1) |
