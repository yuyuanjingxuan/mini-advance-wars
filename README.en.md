...
| 🪖 **9 unit types** | 🪖 Infantry (versatile, can capture) · 🛡️ Heavy (high ATK/DEF, slow-moving, anti-vehicle) · 🚙 Recon (fast scout, weak in combat) · Cannon (CSS-drawn icon, range 2-3) · 🔧 Engineer (1.5× capture + repair) · ⚕️ Medic (heals) · Tank (CSS-drawn icon, assault main force) · 🚀 Rocket (range 3-5, low mobility) · 🚚 Transport (unarmed, carries foot units) |
