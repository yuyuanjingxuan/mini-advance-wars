...
| 🔧 **Support units** | Engineer can repair an adjacent vehicle +3 HP, medic can heal an adjacent infantry/heavy/engineer +4 HP (click the action button, then click the specific target; pick freely when several are adjacent); both have very low ATK (engineer 2 / medic 1) |
