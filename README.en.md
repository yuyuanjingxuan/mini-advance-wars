...
| 🪖 **9 unit types** | 🪖 Infantry (versatile, can capture) · 🛡️ Heavy (high ATK/DEF, anti-vehicle) · 🚙 Recon (fast raider) · Cannon (CSS-drawn icon, range 2-3) · 🔧 Engineer (1.5× capture + repair) · ⚕️ Medic (heals) · Tank (CSS-drawn icon, assault main force) · 🚀 Rocket (range 3-5) · 🚚 Transport (unarmed, carries foot units) |
...
| 🚚 **Transport** | Unarmed transport (move 5) carries 1 foot unit (infantry/heavy/engineer/medic) past terrain limits; move onto its tile to board, select it and click Unload to disembark (the rider can still act that turn); cargo is destroyed along with the transport |
