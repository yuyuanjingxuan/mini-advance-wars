...
const I18N={
  zh:{
    ...
    langLabel:'🌐 Language:',
    // 菜单帮助段落
    m1:'🪖 <b>4+2 种兵种</b>：🪖步兵 · 🛡️重装兵 · 🚙侦察车 · 💣火炮 · 🔧工程师（占领×1.5+修理）· ⚕️军医（治疗）',
    m2:'💣 <b>目标</b>：消灭全部敌军，或占领全部城镇。点击己方单位 → 点<b>蓝格</b>移动 → 点<b>红框敌人</b>攻击。',
    m3:'🟠<b>橙格</b>=攻击范围（虚线），🔵<b>蓝格</b>=移动范围。再点一次选中单位=取消选择；或点侧栏「⏳ 待机」原地结束行动。',
    m4:'🌲森林 / ⛰️山地提供<b>防御加成</b>但移动缓慢，🌊河流无法通行，🏙️城镇在回合开始时回复 2 HP。',
    m5:'🚩<b>占领城镇</b>：只有步兵/工程师能占领（工程师 1.5 倍速度），站上城镇待机积累进度（进度=当前 HP×倍率，满 20 占领，离开进度清零）。占领全部城镇也可获胜！敌军同样会占领，被夺走的城镇不再为你回血。',
    m6:'🖱️ 选中单位后，鼠标悬停会显示<b>移动路径箭头</b>（绿格+箭头指示方向）；点击敌军可查看其<b>移动/攻击范围</b>。',
    m7:'💥 有命中与会心一击；⬆️ 战斗获得经验并<b>升级</b>——敌军同样会升级，速战速决！',
    // 帮助对话框
    ...
    uInf:'多面手，可占领城镇', uHeavy:'高攻高防的近战主力', uRecon:'高速突袭，装甲薄弱（载具）',
    uArtillery:'远程轰击，移动后不能开火（载具）', uEngineer:'占领 1.5 倍速度，修理相邻载具 +3 HP', uMedic:'治疗相邻步兵/工程师 +4 HP',
    ...
    lFlag:'🚩旗帜 = 城镇归属（蓝=我方，红=敌军，灰=占领中）', lLv:'右上角 I / II / III… = 单位等级（罗马数字）',
    tForest:'🌲 森林：防御 +20%，移动消耗 2', tMountain:'⛰️ 山地：防御 +40%，移动消耗 3',
    tWater:'🌊 河流：不可通行', tCity:'🏙️ 城镇：防御 +30%，回合开始回复 2 HP（仅限己方占领的城镇）', tPlain:'🟩 平原：无加成',
    capRule:'只有<b>步兵</b>和<b>工程师</b>能占领城镇（工程师 1.5 倍速度）。站在城镇上待机或移动结束即积累进度（进度 = 单位当前 HP×倍率，满 20 占领）。<b>离开城镇后进度清零</b>。占领后城镇插上本方旗帜，只有己方城镇才回血。敌军同样会占领，被夺走的城镇会变红旗。<b>占领全部城镇也可获胜</b>。',
    supRule:'🔧 <b>工程师</b>：占领 1.5 倍速度，回合行动后自动修理<b>相邻</b>载具（侦察车/火炮）+3 HP（原地待机也可修理）。<br>⚕️ <b>军医</b>：回合行动后自动治疗<b>相邻</b>步兵/工程师 +4 HP（原地待机也可治疗）。两者攻击都很弱，注意保护。',
    lvlRule:'命中 +8、击毁 +25 经验。<b>辅助单位也有升级途径</b>：占领成功 +8、修理/治疗 +6 经验。升级（上限 <b>Lv.V</b>）攻 +1 防 +1 HP 上限 +2；满级后再获得经验转为恢复 3 HP。敌军同样会升级。',
    viewRule:'点击敌军单位（或已行动的我方单位）可查看其<b>移动范围（半透明蓝格）和攻击范围（橙格虚线）</b>，但不能操作。再点一次取消。',
    combatRule:'命中 90%，会心一击 12%（1.5 倍伤害）；反击伤害为 70%。单位间有克制关系（重装克步兵、侦察克步兵等）。<b>火炮移动后不能开火，只能原地待机开火</b>；其他单位可移动后攻击。不同兵种有专属的攻击/移动音效。战报中我方消息蓝色、敌军消息红色。',
    knowBtn:'知道了',
    // 战斗文案
    ...
    startLog:'⚔️ 战斗开始！消灭所有敌军即可获胜。',
    // 结果
    winTitle:'🎉 胜利！', loseTitle:'💀 战败……',
    winText:(n)=>`历经 ${n} 回合消灭了全部敌军！`, loseText:(n)=>`我军全灭于第 ${n} 回合，再接再厉！`,
    ...
    // 兵种名
    nInfantry:'步兵', nHeavy:'重装兵', nRecon:'侦察车', nArtillery:'火炮', nEngineer:'工程师', nMedic:'军医',
    // 兵种描述
    dInfantry:'多面手，擅长山地作战，可占领城镇', dHeavy:'高攻高防的近战主力', dRecon:'高速突袭，但装甲薄弱（载具）',
    dArtillery:'远程轰击，移动后不能开火（载具）', dEngineer:'占领速度×1.5，修理相邻载具（+3 HP）', dMedic:'治疗相邻步兵/工程师（+4 HP），自身攻击很弱',
    sideP:'我方', sideE:'敌军',
  },
  en:{
    ...
    langLabel:'🌐 Language:',
    m1:'🪖 <b>4+2 unit types</b>: 🪖Infantry · 🛡️Heavy · 🚙Recon · 💣Artillery · 🔧Engineer (1.5× capture + repair) · ⚕️Medic (heal)',
    m2:'💣 <b>Goal</b>: destroy all enemies or capture all cities. Click your unit → <b>blue tile</b> to move → <b>red-outlined enemy</b> to attack.',
    ...
    m4:'🌲Forest / ⛰️mountain give <b>defense bonus</b> but slow movement, 🌊river is impassable, 🏙️city heals 2 HP at turn start.',
    m5:'🚩<b>Capture</b>: only infantry/engineers capture (engineer 1.5×). Stand on a city and wait to build progress (progress = HP × multiplier, 20 to capture, <b>progress resets when leaving</b>). Capturing all cities also wins! Enemies capture too.',
    m6:'🖱️ After selecting, hover shows the <b>move path arrows</b>; click an enemy to inspect its <b>move/attack range</b>.',
    m7:'💥 Hits and crits; ⬆️ gain XP and <b>level up</b> — enemies level up too!',
    ...
    uInf:'Versatile, can capture cities', uHeavy:'Strong melee main force', uRecon:'Fast raider, weak armor (vehicle)',
    uArtillery:'Long-range fire, cannot fire after moving (vehicle)', uEngineer:'1.5× capture, repairs adjacent vehicles +3 HP', uMedic:'Heals adjacent infantry/engineers +4 HP',
    ...
    lFlag:'🚩Flag = city owner (blue=yours, red=enemy, gray=capturing)', lLv:'Top-right I / II / III… = unit level (Roman)',
    tForest:'🌲 Forest: DEF +20%, move cost 2', tMountain:'⛰️ Mountain: DEF +40%, move cost 3',
    tWater:'🌊 River: impassable', tCity:'🏙️ City: DEF +30%, heals 2 HP at turn start (owned cities only)', tPlain:'🟩 Plain: no bonus',
    capRule:'Only <b>infantry</b> and <b>engineers</b> capture (engineer 1.5×). Standing on a city and waiting builds progress (progress = HP × multiplier, 20 to capture). <b>Progress resets to 0 when the unit leaves</b>. Captured cities fly your flag; only owned cities heal. Capturing all cities also wins.',
    supRule:'🔧 <b>Engineer</b>: 1.5× capture; after acting, auto-repairs <b>adjacent</b> vehicles (recon/artillery) +3 HP (waiting in place works too).<br>⚕️ <b>Medic</b>: after acting, auto-heals <b>adjacent</b> infantry/engineers +4 HP (waiting in place works too). Both are weak in combat — protect them.',
    lvlRule:'Hit +8, destroy +25 XP. <b>Support units level too</b>: capture +8, repair/heal +6 XP. Level up (cap <b>Lv.V</b>) grants +1 ATK +1 DEF +2 HP; at max level excess XP heals 3 HP. Enemies level up too.',
    ...
    combatRule:'90% hit, 12% crit (1.5×); counterattack deals 70%. Units have type matchups. <b>Artillery cannot fire after moving — it must wait in place to fire</b>; other units may move then attack. Each unit type has its own attack/move sound. Player log is blue, enemy log is red.',
    knowBtn:'Got it',
    ...
    startLog:'⚔️ Battle start! Destroy all enemies to win.',
    winTitle:'🎉 Victory!', loseTitle:'💀 Defeat…',
    winText:(n)=>`Destroyed all enemies in ${n} turns!`, loseText:(n)=>`Your army fell on turn ${n}. Try again!`,
    ...
    nInfantry:'Infantry', nHeavy:'Heavy', nRecon:'Recon', nArtillery:'Artillery', nEngineer:'Engineer', nMedic:'Medic',
    dInfantry:'Versatile, good in mountains, can capture', dHeavy:'High ATK/DEF melee main', dRecon:'Fast raider, weak armor (vehicle)',
    dArtillery:'Long-range fire, cannot fire after moving (vehicle)', dEngineer:'Capture ×1.5, repairs adjacent vehicles (+3 HP)', dMedic:'Heals adjacent infantry/engineers (+4 HP), weak attack',
...
function setLang(l){
  ...
  const names={infantry:'nInfantry',heavy:'nHeavy',recon:'nRecon',artillery:'nArtillery',engineer:'nEngineer',medic:'nMedic'};
  const descs={infantry:'dInfantry',heavy:'dHeavy',recon:'dRecon',artillery:'dArtillery',engineer:'dEngineer',medic:'dMedic'};
  ...
  TERRAINS.city.name=T('tCity').replace(/^🏙️\s*/,'').split('：')[0];
  applyStaticTexts();
  if(G)render();
}
...
function applyStaticTexts(){
  ...
  const mKeys=['m1','m2','m3','m4','m5','m6','m7'];
  ...
  const hKeys=['hUnit','hLegend','hTerrain','hCap','hSupport','hLevel','hView','hCombat'];
  ...
  if(utable){
    ...
    if(rows.length>=7){
      ...
      const traits=['uInf','uHeavy','uRecon','uArtillery','uEngineer','uMedic'];
      const unames=['nInfantry','nHeavy','nRecon','nArtillery','nEngineer','nMedic'];
      for(let i=1;i<=6;i++){
        const tds=rows[i].querySelectorAll('td');
        if(tds.length>=7){tds[0].textContent=UNIT_TYPES[['infantry','heavy','recon','artillery','engineer','medic'][i-1]].emoji+' '+T(unames[i-1]);tds[6].textContent=T(traits[i-1]);}
      }
    }
  }
  // 图例
  ...
  if(hdPs.length>=6){
    hdPs[0].innerHTML=T('tForest')+'　｜　'+T('tMountain')+'<br>'+T('tWater')+'　｜　'+T('tCity')+'　｜　'+T('tPlain');
