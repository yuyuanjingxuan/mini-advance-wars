...
const I18N={
  zh:{
    ...
    tHq:'🚩 总部：防御 +40%，占领敌方总部获胜，己方总部被占战败', tFactory:'🏭 工厂：防御 +30%，回合开始回复 2 HP，可修理驻守载具',
  ...
  en:{
    ...
    tHq:'🚩 HQ: DEF +40%, capturing the enemy HQ wins, losing yours means defeat', tFactory:'🏭 Factory: DEF +30%, heals 2 HP at turn start, repairs garrisoned vehicles',
