...
const I18N={
  zh:{
    ...
    m4:'🌲森林 / ⛰️山地提供<b>防御加成</b>但移动缓慢，🌊河流无法通行，🏙️城镇/🏭工厂在回合开始时回复 2 HP。<b>每个兵种在不同地形的移动力不同</b>（参考高级战争）：步兵擅长山地，履带单位不能进山，轮胎单位怕森林。',
    ...
    tHq:'🚩 总部：防御 +40%，不可占领', tFactory:'🏭 工厂：防御 +30%，回合开始回复 2 HP，可修理驻守载具',
    capRule:'只有<b>步兵</b>和<b>工程师</b>能占领建筑（城镇/工厂，工程师 1.5 倍速度）。站在建筑上待机或移动结束即积累进度（进度 = 单位当前 HP×倍率，满 20 占领）。<b>离开建筑后进度清零</b>。占领后建筑插上本方旗帜，只有己方建筑才回血。敌军同样会占领，被夺走的建筑会变红旗。<b>站在敌方总部格上即可获胜</b>。',
  ...
  en:{
    ...
    m2:'💣 <b>Goal</b>: destroy all enemies or capture all buildings (cities/factories). Standing on the enemy <b>HQ</b> tile wins instantly! Click your unit → <b>blue tile</b> to move → <b>red-outlined enemy</b> to attack.',
    ...
    tHq:'🚩 HQ: DEF +40%, not capturable', tFactory:'🏭 Factory: DEF +30%, heals 2 HP at turn start, repairs garrisoned vehicles',
    capRule:'Only <b>infantry</b> and <b>engineers</b> capture buildings (cities/factories, engineer 1.5×). Standing on a building and waiting builds progress (progress = HP × multiplier, 20 to capture). <b>Progress resets to 0 when the unit leaves</b>. Captured buildings fly your flag; only owned buildings heal. Enemies capture too. Standing on the enemy HQ tile wins instantly.',
