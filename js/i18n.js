...
const I18N={
  zh:{
    ...
    langLabel:'🌐 Language:',
    // 菜单帮助段落
    m1:'🪖 <b>6+2 种兵种</b>：🪖步兵 · 🛡️重装兵 · 🚙侦察车 · 火炮 · 🔧工程师（占领×1.5+修理）· ⚕️军医（治疗）· 坦克 · 🚀火箭炮',
    m2:'💣 <b>目标</b>：消灭全部敌军，或占领全部建筑（城镇/工厂/总部）。占领敌方<b>总部</b>直接获胜！点击己方单位 → 点<b>蓝格</b>移动 → 点<b>红框敌人</b>攻击。',
    m3:'🟠<b>橙格</b>=攻击范围（虚线），🔵<b>蓝格</b>=移动范围。再点一次选中单位=取消选择；或点侧栏「⏳ 待机」原地结束行动。',
    m4:'🌲森林 / ⛰️山地提供<b>防御加成</b>但移动缓慢，🌊河流无法通行，🏙️城镇/🏭工厂/🚩总部在回合开始时回复 2 HP。<b>每个兵种在不同地形的移动力不同</b>（参考高级战争）：步兵擅长山地，履带单位不能进山，轮胎单位怕森林。',
    m5:'🚩<b>占领建筑</b>：只有步兵/工程师能占领（工程师 1.5 倍速度），站上建筑待机积累进度（进度=当前 HP×倍率，满 20 占领，离开进度清零）。占领全部建筑也可获胜！敌军同样会占领，被夺走的建筑不再为你回血。',
    ...
    uInf:'多面手，可占领建筑，山地移动力好', uHeavy:'高攻高防的近战主力（履带，不可入山地）', uRecon:'高速突袭，装甲薄弱（轮胎，不可入山地）',
    ...
    tForest:'🌲 森林：防御 +20%，步兵消耗 1 / 履带 2 / 轮胎 3', tMountain:'⛰️ 山地：防御 +40%，步兵消耗 2 / 工程师 1 / 载具不可入',
    tWater:'🌊 河流：不可通行（浅滩可过）', tCity:'🏙️ 城镇：防御 +30%，回合开始回复 2 HP（仅限己方占领的建筑）', tPlain:'🟩 平原：无加成，所有兵种消耗 1（轮胎 2）',
    tHq:'🚩 总部：防御 +40%，回合开始回复 2 HP，被占领直接战败', tFactory:'🏭 工厂：防御 +30%，回合开始回复 2 HP，可修理驻守载具',
    capRule:'只有<b>步兵</b>和<b>工程师</b>能占领建筑（城镇/工厂/总部，工程师 1.5 倍速度）。站在建筑上待机或移动结束即积累进度（进度 = 单位当前 HP×倍率，满 20 占领）。<b>离开建筑后进度清零</b>。占领后建筑插上本方旗帜，只有己方建筑才回血。敌军同样会占领，被夺走的建筑会变红旗。<b>占领全部建筑也可获胜，占领敌方总部直接获胜</b>。',
    ...
    combatRule:'命中 90%，会心一击 12%（1.5 倍伤害）；反击伤害为 70%。单位间有克制关系（重装克步兵、坦克克步兵等）。<b>火炮/火箭炮移动后不能开火，只能原地待机开火</b>；其他单位可移动后攻击。不同兵种有专属的攻击/移动音效。战报中我方消息蓝色、敌军消息红色。',
    knowBtn:'知道了',
    // 战斗文案
    ...
    // 兵种描述
    dInfantry:'多面手，擅长山地作战，可占领建筑', dHeavy:'高攻高防的近战主力（履带，不可入山地）', dRecon:'高速突袭，但装甲薄弱（轮胎，不可入山地）',
  ...
  en:{
    ...
    langLabel:'🌐 Language:',
    m1:'🪖 <b>6+2 unit types</b>: 🪖Infantry · 🛡️Heavy · 🚙Recon · Cannon · 🔧Engineer (1.5× capture + repair) · ⚕️Medic (heal) · Tank · 🚀Rocket',
    m2:'💣 <b>Goal</b>: destroy all enemies or capture all buildings (cities/factories/HQ). Capturing the enemy <b>HQ</b> wins instantly! Click your unit → <b>blue tile</b> to move → <b>red-outlined enemy</b> to attack.',
    ...
    m4:'🌲Forest / ⛰️mountain give <b>defense bonus</b> but slow movement, 🌊river is impassable, 🏙️city/🏭factory/🚩HQ heal 2 HP at turn start. <b>Each unit type has different move costs per terrain</b> (Advance Wars style): infantry excel in mountains, treads cannot enter mountains, tires fear forests.',
    m5:'🚩<b>Capture</b>: only infantry/engineers capture (engineer 1.5×). Stand on a building and wait to build progress (progress = HP × multiplier, 20 to capture, <b>progress resets when leaving</b>). Capturing all buildings also wins! Enemies capture too.',
    ...
    uInf:'Versatile, can capture, good mountain mobility', uHeavy:'Strong melee main force (treads, no mountains)', uRecon:'Fast raider, weak armor (tires, no mountains)',
    ...
    tForest:'🌲 Forest: DEF +20%, infantry 1 / treads 2 / tires 3', tMountain:'⛰️ Mountain: DEF +40%, infantry 2 / engineer 1 / vehicles blocked',
    tWater:'🌊 River: impassable (fords passable)', tCity:'🏙️ City: DEF +30%, heals 2 HP at turn start (owned buildings only)', tPlain:'🟩 Plain: no bonus, cost 1 for all (tires 2)',
    tHq:'🚩 HQ: DEF +40%, heals 2 HP at turn start, losing it means defeat', tFactory:'🏭 Factory: DEF +30%, heals 2 HP at turn start, repairs garrisoned vehicles',
    capRule:'Only <b>infantry</b> and <b>engineers</b> capture buildings (cities/factories/HQ, engineer 1.5×). Standing on a building and waiting builds progress (progress = HP × multiplier, 20 to capture). <b>Progress resets to 0 when the unit leaves</b>. Captured buildings fly your flag; only owned buildings heal. Capturing all buildings also wins — capturing the enemy HQ wins instantly.',
    ...
    combatRule:'90% hit, 12% crit (1.5×); counterattack deals 70%. Units have type matchups. <b>Artillery/rocket cannot fire after moving — they must wait in place to fire</b>; other units may move then attack. Each unit type has its own attack/move sound. Player log is blue, enemy log is red.',
    knowBtn:'Got it',
    ...
    dInfantry:'Versatile, good in mountains, can capture', dHeavy:'High ATK/DEF melee main (treads, no mountains)', dRecon:'Fast raider, weak armor (tires, no mountains)',
