...
const I18N={
  zh:{
    ...
    langLabel:'🌐 Language:',
    // 菜单帮助段落
    m1:'🪖 <b>8 种兵种</b>：🪖步兵（多面手·可占领）· 🛡️重装兵（高攻高防·克制载具）· 🚙侦察车（高速突袭）· 火炮（射程 2-3）· 🔧工程师（占领×1.5+修理）· ⚕️军医（治疗）· 坦克（突击主力）· 🚀火箭炮（射程 3-5）',
    ...
    // 兵种描述
    dInfantry:'多面手，擅长山地作战，可占领建筑', dHeavy:'高攻高防的近战主力，对载具 1.5 倍伤害（履带，不可入山地）', dRecon:'高速突袭，但装甲薄弱（轮胎，不可入山地）',
  ...
  en:{
    ...
    langLabel:'🌐 Language:',
    m1:'🪖 <b>8 unit types</b>: 🪖Infantry (versatile, can capture) · 🛡️Heavy (high ATK/DEF, anti-vehicle) · 🚙Recon (fast raider) · Cannon (range 2-3) · 🔧Engineer (1.5× capture + repair) · ⚕️Medic (heals) · Tank (assault main force) · 🚀Rocket (range 3-5)',
    ...
    dInfantry:'Versatile, good in mountains, can capture', dHeavy:'High ATK/DEF melee main, 1.5× damage vs vehicles (treads, no mountains)', dRecon:'Fast raider, weak armor (tires, no mountains)',
