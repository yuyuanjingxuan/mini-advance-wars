...
const UNIT_TYPES={
  ...
  artillery:{name:'火炮', emoji:'💣', hp:10, atk:7, def:1, move:2, minR:2, maxR:3, desc:'远程轰击，移动后不能开火（载具）'},
  engineer:{name:'工程师', emoji:'🔧', hp:10, atk:2, def:1, move:3, minR:1, maxR:1, desc:'占领速度×1.5，修理相邻载具（+3 HP）'},
...
const DMG_MULT={
  ...
  engineer:{infantry:0.5, heavy:0.3,  recon:0.4,  artillery:0.5, engineer:1.0, medic:0.8},
  medic:   {infantry:0.35,heavy:0.2,  recon:0.35, artillery:0.35,engineer:0.8, medic:1.0},
};
