...
| 🪖 **4+2 种兵种** | 🪖 步兵 · 🛡️ 重装兵 · 🚙 侦察车 · 🎯 火炮（射程 2-3，无法反击）· 🔧 工程师（占领 1.5 倍+修理载具）· ⚕️ 军医（治疗步兵） |
| ⚔️ **兵种克制** | 完整克制倍率表（重装克步兵、侦察克步兵但被重装克等） |
| 🌲 **地形效果** | 🌲森林 +20%防 · ⛰️山地 +40%防（移动慢）· 🌊河流不可通行 · 🏙️城镇 +30%防且回合回血 2 |
| 🚩 **城镇占领** | 高级战争式占领：只有步兵/工程师能占领（工程师 1.5 倍速度），站上城镇待机积累进度（进度=当前 HP×倍率，满 20 占领），插旗归属、被夺走会变红旗；占领全部城镇也可获胜 |
| 🔧 **辅助单位** | 工程师自动修理相邻载具 +3 HP；军医自动治疗相邻步兵/工程师 +4 HP |
