...
| 🪖 **4+2 种兵种** | 🪖 步兵 · 🛡️ 重装兵 · 🚙 侦察车 · 💣 火炮（射程 2-3，移动后不能开火）· 🔧 工程师（占领 1.5 倍+修理载具）· ⚕️ 军医（治疗步兵） |
| ⚔️ **兵种克制** | 完整克制倍率表（重装克步兵、侦察克步兵但被重装克等） |
| 🌲 **地形效果** | 🌲森林 +20%防 · ⛰️山地 +40%防（移动慢）· 🌊河流不可通行 · 🏙️城镇 +30%防且回合回血 2 |
| 🚩 **城镇占领** | 高级战争式占领：只有步兵/工程师能占领（工程师 1.5 倍速度），站上城镇待机积累进度（进度=当前 HP×倍率，满 20 占领，离开进度清零），插旗归属、被夺走会变红旗；占领全部城镇也可获胜 |
...
| 🔊 **音效** | WebAudio 芯片音效：开局号角、兵种专属攻击/移动音、会心、击毁爆炸、升级、占领、修理、治疗、回合切换、胜负（可静音） |
...
> 💡 森林/山地提供防御加成但移动缓慢，每个兵种在不同地形的移动力不同（步兵擅长山地，履带单位不能进山）；占领建筑每回合回复 2 HP；火炮/火箭炮移动后不能开火，只能原地待机开火。
